...
def play(player1, player2, player_type):
    ...
    while not win:
        ...
        if player_type == 1:
            print(player2)
            print(player1)
            win = player1.computer_turn(number) or player2.player_turn(number)
        elif player_type == 2:
            print(player2)
            win = player2.player_turn(number)

            if win:
                if player2.win:
                    print(f"Выиграл {repr(player2)}")
                else:
                    print(win)
                break

            print(player1)
            win = player1.player_turn(number)
        else:
            print(player2)
            print(player1)
...
def main():
    ...
    if players_type == "1":
        ...
        play(player_comp1, player_comp2, 3)
